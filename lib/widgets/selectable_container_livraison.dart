...
class SelectableContainerLivraison extends StatefulWidget {
  const SelectableContainerLivraison({
    super.key,
    required this.onSelect,
  });

  final void Function(
      (String img, String label, String prix, int value) selected) onSelect;
              ...
              children: [
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                customCenterText(livraisonsList[i].$2,
                                    maxLines: 2,
                                    textAlign: TextAlign.center,
                                    style:
                                        TextStyle(color: DARK, fontSize: 11)),
                                customCenterText("A partir de",
                                    maxLines: 3,
                                    textAlign: TextAlign.center,
                                    style:
                                        TextStyle(color: LIGHT, fontSize: 10)),
                                espacementWidget(height: 3),
                                customCenterText("${livraisonsList[i].$3} XAF",
                                    maxLines: 3,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: BLUE,
                ...
                Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color:
                              selectedValue == livraisonsList[i] ? BLUE : GREY,
