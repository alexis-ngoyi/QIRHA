...
import 'package:qirha/main/parametres/accessibilite.dart';
import 'package:qirha/main/parametres/compte.dart';
import 'package:qirha/main/parametres/mentions_legales.dart';
            ...
            if (needToLogin == false)
              GestureDetector(
                ...
                child: Container(
                  ...
                  color: WHITE,
                  child: const Center(child: Text('Deconnexion')),
                ),
              ),
            espacementWidget(height: 7),
            const Center(child: qirhaVersion()),
            espacementWidget(height: 20),
          ],
        ),
      ),
