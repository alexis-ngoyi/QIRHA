...
class _DetailCommandeProduitState extends State<DetailCommandeProduit> {
  ...
  getArticlesCommande() async {
    ...
    var articles = await ApiServices()
        .getArticlesCommande(widget.commande.commande_id.toString());

    articles.forEach((article) {
      setState(() {
        ListArtclesCommande.add(ArticlesCommandeModel(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () => CustomPageRoute(
                                const MoyenDePaiementCommande(), context),
                            child: Container(
                              ...
                              child: Center(
                                child: customText('VALIDER LA COMMANDE',
                                    style:
          ...
          children: [
            Row(
              ...
              children: [
                ...
                customText("Resume de la commande",
                    style: TextStyle(
                        color: DARK,
                        fontSize: 13,
                        fontWeight: FontWeight.bold)),
                ...
                Row(
                    ...
                    children: [
                      ...
                      Container(
                          child: customText(
                              formatMoney((double.parse("2040") +
                                      double.parse(widget.commande.montant_total
                                          .toString()))
                                  .toString()),
                              style: TextStyle(
                                  color: DARK,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  border: Border.all(
                      width: 1, color: Colors.black.withOpacity(.08)),
                  color: const Color.fromARGB(118, 244, 67, 54),
                  borderRadius: BorderRadius.circular(4)),
              child: Center(
                child: customText('Annuler la commande',
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(4)),
              child: Center(
                child: customText('Service client',
        ...
        children: [
          Row(
            ...
            children: [
              ...
              espacementWidget(width: 7),
              customText(statusCommande(widget.commande.status.toString()),
                  style: TextStyle(
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              customText('Adresse de Livraison',
                  style: TextStyle(
                      color: DARK, fontSize: 13, fontWeight: FontWeight.bold)),
              Row(
                children: [
      ...
      child: Row(
        ...
        children: [
          roundedImageContainer(
              image: article.photo_cover.toString(), width: 75, height: 75),
          ...
          Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    customText('${article.nom_couleur}; ${article.code_taille}',
                        style: const TextStyle(
                          fontSize: 11,
                          overflow: TextOverflow.ellipsis,
                        )),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  customText(formatMoney(article.prix_unitaire.toString()),
                      style: const TextStyle(
                          fontSize: 14,
                          overflow: TextOverflow.ellipsis,
                          fontWeight: FontWeight.bold)),
                  ...
                  customText(article.quantite.toString(),
                      style: TextStyle(fontSize: 13, color: LIGHT)),
                ],
              ),
              customText(
    ...
    return Container(
      ...
      child: Table(
        children: [
          TableRow(children: [
            TableCell(
                child: customText('Commande #',
                    style: TextStyle(color: LIGHT, fontSize: 13))),
            TableCell(
                child: Row(
              children: [
                customText('$prefixCodeCommande${widget.commande.commande_id}',
                    style: TextStyle(color: DARK, fontSize: 11)),
                espacementWidget(width: 10),
                GestureDetector(
                  onTap: () => copyToClipBoard(context,
                      text: '$prefixCodeCommande${widget.commande.commande_id}',
          ...
          TableRow(children: [
            TableCell(
                child: customText('Date de la commande',
                    style: TextStyle(color: LIGHT, fontSize: 13))),
            TableCell(
                child: customText(widget.commande.date_commande.toString(),
                    style: TextStyle(color: DARK, fontSize: 11))),
          ]),
          TableRow(children: [
            TableCell(
                child: customText('Accepte la livraison ?',
                    style: TextStyle(color: LIGHT, fontSize: 13))),
            TableCell(
                            ...
                            children: [
                              ...
                              customCenterText(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 15)),
                              espacementWidget(height: 8),
                              if (widget.commande.accepte_la_livraison == "0")
                                Container(
                                  width: MediaQuery.of(context).size.width,
                                  ...
                                  child: customCenterText(
                                      ...
                                      textAlign: TextAlign.center,
                                      style:
                                          TextStyle(color: DARK, fontSize: 11)),
                                ),
              ...
              child: customText("Non ( recuperation dans les locaux de Qirha)",
                  maxLines: 2, style: TextStyle(color: DARK, fontSize: 11)),
            )),
          ])
        ],
      ),
