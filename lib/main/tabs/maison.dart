...
class MainTabMaisonScreen extends StatefulWidget {
  const MainTabMaisonScreen({super.key});

  @override
  State<MainTabMaisonScreen> createState() => _MainTabMaisonScreenState();
}

class _MainTabMaisonScreenState extends State<MainTabMaisonScreen> {
  final List<String> imageList = <String>[img_bazard10];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_maison, libelle: 'Textille domestique'),
    CategorieModel(img: img_maison, libelle: 'Art Mural'),
    CategorieModel(img: img_maison, libelle: 'Accessoire douche'),
    CategorieModel(img: img_maison, libelle: 'Terasse'),
    CategorieModel(img: img_maison, libelle: 'Eclairage'),
    CategorieModel(img: img_maison, libelle: 'Decoration'),
    CategorieModel(img: img_maison, libelle: 'Robinet'),
    CategorieModel(img: img_maison, libelle: 'Cuisine'),
    CategorieModel(img: img_maison, libelle: 'Meuble'),
    CategorieModel(img: img_maison, libelle: 'Salle a manger'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListMaison.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListMaison[i],
              ),
          ],
        ),
      ),
