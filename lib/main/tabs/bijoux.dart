...
class MainTabBijouxScreen extends StatefulWidget {
  const MainTabBijouxScreen({super.key});

  @override
  State<MainTabBijouxScreen> createState() => _MainTabBijouxScreenState();
}

class _MainTabBijouxScreenState extends State<MainTabBijouxScreen> {
  final List<String> imageList = <String>[img_bazard16];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard16, libelle: 'Bracelet'),
    CategorieModel(img: img_bazard16, libelle: 'Collier'),
    CategorieModel(img: img_bazard16, libelle: 'Bague'),
    CategorieModel(img: img_bazard16, libelle: "Boucle d oreille"),
    CategorieModel(img: img_bazard16, libelle: 'Bijoux en or'),
    CategorieModel(img: img_bazard16, libelle: 'Bijoux en argent'),
    CategorieModel(img: img_bazard16, libelle: 'Bijoux enfant'),
    CategorieModel(img: img_bazard16, libelle: 'Bijoux homme'),
    CategorieModel(img: img_bazard16, libelle: 'Charme bijoux homme'),
    CategorieModel(img: img_bazard16, libelle: 'Charme bijoux femme'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListBijoux.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListBijoux[i],
              ),
          ],
        ),
      ),
