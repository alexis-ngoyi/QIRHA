...
class MainTabBureauxScreen extends StatefulWidget {
  const MainTabBureauxScreen({super.key});

  @override
  State<MainTabBureauxScreen> createState() => _MainTabBureauxScreenState();
}

class _MainTabBureauxScreenState extends State<MainTabBureauxScreen> {
  final List<String> imageList = <String>[img_bazard17];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard17, libelle: 'Poste de travail informatique'),
    CategorieModel(img: img_bazard17, libelle: 'Burequ industriel'),
    CategorieModel(img: img_bazard17, libelle: 'Bureau jardin'),
    CategorieModel(img: img_bazard17, libelle: "Bureau retro"),
    CategorieModel(img: img_bazard17, libelle: 'Burequ metal'),
    CategorieModel(img: img_bazard17, libelle: 'Bureau en bois'),
    CategorieModel(img: img_bazard17, libelle: 'Bureau rectangulaire'),
    CategorieModel(img: img_bazard17, libelle: 'Bureau carre'),
    CategorieModel(img: img_bazard17, libelle: 'Charme oval'),
    CategorieModel(img: img_bazard17, libelle: 'Charme rond'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListBureaux.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListBureaux[i],
              ),
          ],
        ),
      ),
