...
class MainTabSanteBeauteScreen extends StatefulWidget {
  const MainTabSanteBeauteScreen({super.key});

  @override
  State<MainTabSanteBeauteScreen> createState() =>
      _MainTabSanteBeauteScreenState();
}

class _MainTabSanteBeauteScreenState extends State<MainTabSanteBeauteScreen> {
  final List<String> imageList = <String>[img_bazard12];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard12, libelle: 'Lait Naturel femme'),
    CategorieModel(img: img_bazard12, libelle: 'Lait Naturel femme'),
    CategorieModel(img: img_bazard12, libelle: 'Lait eclaircissant femme'),
    CategorieModel(img: img_bazard12, libelle: 'Lait eclaircissant femme'),
    CategorieModel(img: img_bazard12, libelle: 'Soin de visage femme'),
    CategorieModel(img: img_bazard12, libelle: 'Soin de visage homme'),
    CategorieModel(img: img_bazard12, libelle: 'Soin de corporel homme'),
    CategorieModel(img: img_bazard12, libelle: 'Soin de corporel homme'),
    CategorieModel(img: img_bazard12, libelle: 'Accesoire homme'),
    CategorieModel(img: img_bazard12, libelle: 'Accessoire homme'),
  ];
          ...
          child: Column(
            children: [
              Stack(children: [
                ...
                Positioned(
                    top: 0, right: 10, child: BannerCarouselIndicator(context)),
              ]),
              Column(
                children: [
                  Container(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: roundedImageContainer(
                                        image:
                                            CategorieList[index].img as String),
                                  ),
                                ),
                              ),
                              Padding(
                  ...
                  labelWithIcon(
                      icon: HeroIcons.fire, label: 'Les plus populaire'),
                  StaggeredGrid.count(
                    crossAxisCount: 2,
                    crossAxisSpacing: 10,
                    mainAxisSpacing: 12,
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListBeauteSante.length; i++)
              BazardRapidItem(context,
                  reduction: true, produit: imageBazardListBeauteSante[i])
          ],
        ),
      ),
    );
