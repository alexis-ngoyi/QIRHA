...
class MainTabSommeilScreen extends StatefulWidget {
  const MainTabSommeilScreen({super.key});

  @override
  State<MainTabSommeilScreen> createState() => _MainTabSommeilScreenState();
}

class _MainTabSommeilScreenState extends State<MainTabSommeilScreen> {
  final List<String> imageList = <String>[img_bazard18];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard18, libelle: 'Lingue del lit'),
    CategorieModel(img: img_bazard18, libelle: 'Couverture femme'),
    CategorieModel(img: img_bazard18, libelle: 'Couette et parrure de lit'),
    CategorieModel(img: img_bazard18, libelle: "Couverture homme"),
    CategorieModel(img: img_bazard18, libelle: 'Couverture enfant et bebe'),
    CategorieModel(img: img_bazard18, libelle: 'Nounours'),
    CategorieModel(img: img_bazard18, libelle: 'Accessoire'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListSommeil.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListSommeil[i],
              ),
          ],
        ),
      ),
