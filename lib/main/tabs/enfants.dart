...
class MainTabEnfantsScreen extends StatefulWidget {
  const MainTabEnfantsScreen({super.key});

  @override
  State<MainTabEnfantsScreen> createState() => _MainTabEnfantsScreenState();
}

class _MainTabEnfantsScreenState extends State<MainTabEnfantsScreen> {
  final List<String> imageList = <String>[img_bazard9];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard9, libelle: 'Vetements filles'),
    CategorieModel(img: img_bazard9, libelle: 'Vetements garcons'),
    CategorieModel(img: img_bazard9, libelle: 'Jeune fille'),
    CategorieModel(img: img_bazard9, libelle: 'Jeune enfant'),
    CategorieModel(img: img_bazard9, libelle: 'Ensemble complet'),
    CategorieModel(img: img_bazard9, libelle: 'Ensemble fille'),
    CategorieModel(img: img_bazard9, libelle: 'T-shirt garcon'),
    CategorieModel(img: img_bazard9, libelle: 'Costume garcons'),
    CategorieModel(img: img_bazard9, libelle: 'Accessoire fille'),
    CategorieModel(img: img_bazard9, libelle: 'Accessoire garcons'),
    CategorieModel(img: img_bazard9, libelle: 'Chaussure fille'),
    CategorieModel(img: img_bazard9, libelle: 'Chaussure Garcons'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListEnfant.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListEnfant[i],
              ),
          ],
        ),
      ),
