...
class MainTabJouetsScreen extends StatefulWidget {
  const MainTabJouetsScreen({super.key});

  @override
  State<MainTabJouetsScreen> createState() => _MainTabJouetsScreenState();
}

class _MainTabJouetsScreenState extends State<MainTabJouetsScreen> {
  final List<String> imageList = <String>[img_bazard15];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard15, libelle: 'Jouets de construction'),
    CategorieModel(img: img_bazard15, libelle: 'Jouet animes'),
    CategorieModel(img: img_bazard15, libelle: 'Jeu de societe'),
    CategorieModel(img: img_bazard15, libelle: 'Animaux'),
    CategorieModel(img: img_bazard15, libelle: 'Jeu interactif'),
    CategorieModel(img: img_bazard15, libelle: 'Jouet de bain'),
    CategorieModel(img: img_bazard15, libelle: 'Telephone pour bebe'),
    CategorieModel(img: img_bazard15, libelle: 'Figurine'),
    CategorieModel(img: img_bazard15, libelle: 'Jouet pour fille'),
    CategorieModel(img: img_bazard15, libelle: 'Jouet pour garcon'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListJouet.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListJouet[i],
              ),
          ],
        ),
      ),
