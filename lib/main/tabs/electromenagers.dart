...
class MainTabElectromenagerScreen extends StatefulWidget {
  const MainTabElectromenagerScreen({super.key});

  @override
  State<MainTabElectromenagerScreen> createState() =>
      _MainTabElectromenagerScreenState();
}

class _MainTabElectromenagerScreenState
    extends State<MainTabElectromenagerScreen> {
  final List<String> imageList = <String>[img_bazard14];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard14, libelle: 'Mixeur'),
    CategorieModel(img: img_bazard14, libelle: 'Cafetiere'),
    CategorieModel(img: img_bazard14, libelle: 'Congelateur'),
    CategorieModel(img: img_bazard14, libelle: 'Four'),
    CategorieModel(img: img_bazard14, libelle: 'Micro-onde'),
    CategorieModel(img: img_bazard14, libelle: 'Refrigerateur'),
    CategorieModel(img: img_bazard14, libelle: 'Machine'),
    CategorieModel(img: img_bazard14, libelle: 'Fritteuse'),
    CategorieModel(img: img_bazard14, libelle: 'Grille electrique'),
    CategorieModel(img: img_bazard14, libelle: 'Robots menagers'),
    CategorieModel(img: img_bazard14, libelle: 'Gros electromenager'),
    CategorieModel(img: img_bazard14, libelle: 'Accessoire'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListElectromenager.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListElectromenager[i],
              ),
          ],
        ),
      ),
