...
class MainTabSportScreen extends StatefulWidget {
  const MainTabSportScreen({super.key});

  @override
  State<MainTabSportScreen> createState() => _MainTabSportScreenState();
}

class _MainTabSportScreenState extends State<MainTabSportScreen> {
  final List<String> imageList = <String>[img_bazard13];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard13, libelle: 'Bat homme'),
    CategorieModel(img: img_bazard13, libelle: 'Bat femme'),
    CategorieModel(img: img_bazard13, libelle: 'Casquette femme'),
    CategorieModel(img: img_bazard13, libelle: 'Casquette homme'),
    CategorieModel(img: img_bazard13, libelle: 'Sac homme'),
    CategorieModel(img: img_bazard13, libelle: 'Sac femme'),
    CategorieModel(img: img_bazard13, libelle: 'Pontalon homme'),
    CategorieModel(img: img_bazard13, libelle: 'Pontalon femme'),
    CategorieModel(img: img_bazard13, libelle: 'ensemble homme'),
    CategorieModel(img: img_bazard13, libelle: 'ensemble femme'),
    CategorieModel(img: img_bazard13, libelle: 'Accesoire homme'),
    CategorieModel(img: img_bazard13, libelle: 'Accessoire homme'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListSport.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListSport[i],
              ),
          ],
        ),
      ),
