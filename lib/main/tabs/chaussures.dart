...
class MainTabChaussuresScreen extends StatefulWidget {
  const MainTabChaussuresScreen({super.key});

  @override
  State<MainTabChaussuresScreen> createState() =>
      _MainTabChaussuresScreenState();
}

class _MainTabChaussuresScreenState extends State<MainTabChaussuresScreen> {
  final List<String> imageList = <String>[img_bazard2];
  ...
  final List<CategorieModel> CategorieList = <CategorieModel>[
    CategorieModel(img: img_bazard2, libelle: 'Talon femme'),
    CategorieModel(img: img_bazard2, libelle: 'Botte femme'),
    CategorieModel(img: img_bazard2, libelle: 'Basket femme'),
    CategorieModel(img: img_bazard2, libelle: 'Sac femme'),
    CategorieModel(img: img_bazard2, libelle: 'Mocassins femme'),
    CategorieModel(img: img_bazard2, libelle: 'Accessoire femme'),
    CategorieModel(img: img_bazard2, libelle: 'Talon homme'),
    CategorieModel(img: img_bazard2, libelle: 'Botte homme'),
    CategorieModel(img: img_bazard2, libelle: 'Basket homme'),
    CategorieModel(img: img_bazard2, libelle: 'Sac homme'),
    CategorieModel(img: img_bazard2, libelle: 'Mocassins homme'),
    CategorieModel(img: img_bazard2, libelle: 'Accessoire homme'),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            for (var i = 0; i < imageBazardListChaussure.length; i++)
              BazardRapidItem(
                context,
                reduction: true,
                produit: imageBazardListChaussure[i],
              ),
          ],
        ),
      ),
